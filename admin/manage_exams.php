...
?>
    ...
    <div class="bm-admin-content">
        ...
        <form method="POST">
            <h2>Thêm đề thi</h2>
            Tên đề thi: <input type="text" class="form-control regular-text" name="exam_name" required><br>
            Thời gian làm bài: <input type="number" class="form-control regular-text" name="exam_time" required><br>
            <input type="submit" class="button btn-submit" name="add_exam" value="Thêm">
        </form>
        ...
        <table border="1" class="table-list">
            <tr>
                ...
                <th class="manage-column">Tên đề thi</th>
                <th class="manage-column">Thời gian làm bài</th>
