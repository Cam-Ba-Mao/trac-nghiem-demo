							...
							children: [ {
								...
								html: '<div>' + CKEDITOR.tools.htmlEncode( editor.lang.common.preview ) + '<br>' +
									...
									// jscs:disable maximumLineLength
										( editor.config.image_previewText || 'Hiển thị hình ảnh xem trước tại đây. Đường viền: tạo viền cho hình ảnh. Khoảng đệm ngang: cách nội dung 1 khoảng về phía trái và phải. Khoảng đệm dọc: cách nội dung 1 khoảng về phía trên và dưới. Vị trí: Hình ảnh sẽ được canh trái hoặc phải.' ) +
